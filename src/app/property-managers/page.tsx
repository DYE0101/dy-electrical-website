...
const faqItems = [
  {
    ...
    answer:
      "Yes — we coordinate directly with tenants to book access. We keep the property manager informed without copying them on every exchange.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes — after every job you receive clear notes covering what was found, what was done, and any follow-up items. Suitable for owner reporting, VCAT, and agency records.",
  },
  {
  ...
  {
    question: "Do you work with multiple agencies or do you have a preference?",
    answer:
      "We work with property managers and agencies of all sizes. We do not require exclusivity agreements — we focus on making every job straightforward regardless of your current trade arrangements.",
  },
];
...
export const metadata: Metadata = {
  title: "Electrical for Property Managers | DY Electrical Services",
  description:
    "Responsive electrical maintenance for property managers across Logan, Brisbane Southside and the Northern Gold Coast. We attend when booked, communicate directly with tenants, and send clear job notes.",
...
const features = [
  {
    ...
    body: "We coordinate directly with your tenants to book access — you don't need to be the go-between. We keep you informed, not copied on every message.",
  },
  {
    ...
    <main className="bg-brand-background">
      ...
      <section className="mx-auto w-full max-w-[1180px] px-4 py-16 lg:py-24">
        ...
        <p className="mt-5 max-w-2xl text-base leading-7 text-brand-charcoal/70 md:text-lg">
          Clear communication, responsive scheduling and tidy documentation for
          rental and managed property electrical work across Logan, Brisbane
          Southside and the Northern Gold Coast.
        </p>
      </section>
      ...
      <section className="border-t border-gray-100 bg-brand-background">
        <div className="mx-auto grid w-full max-w-[1180px] gap-12 px-4 py-16 lg:grid-cols-[1fr_.85fr] lg:py-24">
          ...
          <InquiryForm
            ...
            ctaClicked="property_manager_page_form"
          />
        </div>
      </section>
        ...
        <div className="mx-auto w-full max-w-[1180px] px-4 py-14 lg:py-20 flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-white/60">
              Send through your portfolio details and we&apos;ll discuss coverage
